...
public class HomeWork5 {
    ...
    public static void main(String[] args) {
        ...
        measureTime(() -> sequentialMethod(data1), "Последовательный");
        measureTime(() -> parallelMethod(data2), "Параллельный");
        System.out.println("Массивы друг другу равны? - " + Arrays.equals(data1, data2));
    }
    private static float[] createArray() {
        float[] data = new float[HomeWork5.SIZE];
    ...
    private static void measureTime(Runnable action, String actionName) {
        ...
        System.out.printf("%s метод занял %d ms%n", actionName, duration);
    }
}
